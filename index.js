...
addEventListener("keydown", (event) => {
    if ((event.key == "w" || event.key == "W" || event.key == "8") && !snake.down && step) {
        snake.right = false;
        snake.left = false;
        snake.up = true;
        step = false;
    } else if ((event.key == "s" || event.key == "S"|| event.key == "2") && !snake.up && step) {
        snake.right = false;
        snake.left = false;
        snake.down = true;
        step = false;
    }
    if ((event.key == "a" || event.key == "A" || event.key == "4") && !snake.right && step) {
        snake.up = false;
        snake.down = false;
        snake.left = true;
        step = false;
    }
    if ((event.key == "d" || event.key == "D" || event.key == "6") && !snake.left && step) {
        snake.up = false;
        snake.down = false;
        snake.right = true;
        step = false;
